import 'package:torbaaz/models/restaurant_data_model.dart';

class RestaurantDataService {
  // List of all restaurant data
  static List<RestaurantDataModel> getAllRestaurants() {
    return [
  ...
  static RestaurantDataModel? getRestaurantById(String id) {
    try {
      return getAllRestaurants().firstWhere((r) => r.id == id);
    } catch (e) {
      return null;
    }
  }
  ...
  static RestaurantDataModel? getRestaurantByName(String name) {
    try {
